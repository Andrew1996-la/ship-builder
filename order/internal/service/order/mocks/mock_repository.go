...
func (_mock *Repository) Create(ctx context.Context, order model.Order) error {
...
func (_c *Repository_Create_Call) RunAndReturn(run func(ctx context.Context, order model.Order) error) *Repository_Create_Call {
	_c.Call.Return(run)
	return _c
}
